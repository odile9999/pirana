...
class Ui_DockWidget_MassTabSelector(object):
    def setupUi(self, DockWidget_MassTabSelector):
        DockWidget_MassTabSelector.setObjectName(_fromUtf8("DockWidget_MassTabSelector"))
        ...
        DockWidget_MassTabSelector.setFeatures(QtGui.QDockWidget.DockWidgetFloatable|QtGui.QDockWidget.DockWidgetMovable)
        ...
        self.pushButton_ChangeList.setObjectName(_fromUtf8("pushButton_ChangeList"))
    ...
    def retranslateUi(self, DockWidget_MassTabSelector):
        DockWidget_MassTabSelector.setWindowTitle(_translate("DockWidget_MassTabSelector", "MassTab Selector", None))
        self.pushButton_ChangeList.setText(_translate("DockWidget_MassTabSelector", "Change List", None))
